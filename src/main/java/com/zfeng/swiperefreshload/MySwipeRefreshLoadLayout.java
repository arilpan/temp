            ...
            case MotionEvent.ACTION_CANCEL:
                if (canChildScrollUp()) {
                    if (mTarget instanceof AbsListView) {
                        ...
                        StaggeredGridLayoutManager lLManager = (StaggeredGridLayoutManager) recyclerView.getLayoutManager();

                        if (lLManager.findLastVisibleItemPositions(new int[]{1})[0] == lLManager.getItemCount()) {
                            if (mCanLoadMore) {
                                mCanLoadMore = false;
                                mLoadMoreListener.loadMore();
                            }
