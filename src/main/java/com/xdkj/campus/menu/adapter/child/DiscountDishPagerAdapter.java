 ...
 */
public class DiscountDishPagerAdapter extends RecyclerView.Adapter<DiscountDishPagerAdapter.MyViewHolder>
{
    ...
    public DiscountDishPagerAdapter(Context context)
    {
    ...
    @Override
    public void onBindViewHolder(MyViewHolder newholder, int position)
    {
        if (mItems != null)
        {
