...
public class APIDishRank
{
     ...
     * label_type : 新品尝鲜
     * package_type :
     * upload_url : /GrogshopUpload/dishes/20160810170428755ymz.jpg
     * dishes_name : 玉米汁
     * dishes_price : 48.00
     * rack_rate : 48.00
     * dishes_description : 味道可口。
     * appointment_notice : 提前一小时预约。
     * purchase_count : 1
     * purchase_persons : null
     * dishes_select_status : null
     * discount_type : 0
     * add_user : 测试管理员
     * add_time : 2016-08-10 17:04:29
     * update_user : null
     * update_time : null
     * del_user : null
     * del_flag : 0
