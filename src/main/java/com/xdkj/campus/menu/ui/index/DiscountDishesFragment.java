...
import com.xdkj.campus.menu.adapter.child.DiscountDishPagerAdapter;
...

{
    ...
    private DiscountDishPagerAdapter mAdapter;
    ...
    private void initView(View view) {
        ...
        mAdapter = new DiscountDishPagerAdapter(getContext());
...
//        initRecyclerView();
    ...
    public static List<APPDishDiscount.ValueBean.DataBean> removeDuplicate(List<APPDishDiscount.ValueBean.DataBean> list) {
