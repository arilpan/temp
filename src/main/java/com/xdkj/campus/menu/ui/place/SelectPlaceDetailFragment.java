...
//        };
        if (APIAddr.select_mall == APIAddr.ONE) {
            Log.e("arilpan", "APIAddr.BASE_IMG_URL+APIAddr.shop_one_icon:" + APIAddr.BASE_IMG_URL + APIAddr.shop_one_icon);
            Glide.with(SelectPlaceDetailFragment.this).load(APIAddr.BASE_IMG_URL + APIAddr.shop_one_icon).error(R.drawable.pre_order_title)
...
//            ((TextView)view.findViewById(R.id.shop_addr)).setText(APIAddr.shop_one_phone);
            ...
            Glide.with(SelectPlaceDetailFragment.this).load(APIAddr.BASE_IMG_URL + APIAddr.shop_two_icon).error(R.drawable.pre_order_title)
                    .into(new SimpleTarget<GlideDrawable>() {
                        @Override
                        public void onResourceReady(GlideDrawable resource, GlideAnimation<? super GlideDrawable> glideAnimation) {
                            shop_bg.setBackgroundDrawable(resource);
